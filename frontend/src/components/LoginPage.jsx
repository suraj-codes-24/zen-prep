...
function LoginPage({ onLogin, onBack }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0B0F1E", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.1fr 1fr", fontFamily: "Inter", overflow: "hidden" }}>
      <div style={{ background: "linear-gradient(160deg, #0F1629 0%, #131B36 50%, #0F1629 100%)", padding: isMobile ? "24px 20px" : "40px 48px", display: "flex", flexDirection: "column", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ background: "rgba(15,22,41,0.8)", backdropFilter: "blur(12px)", borderRadius: 16, overflow: "hidden", border: "1px solid rgba(201,168,76,0.15)", marginBottom: 28, boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr 1fr", gap: 1, background: "rgba(255,255,255,0.03)" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: isMobile ? "24px 20px" : 36 }}>
